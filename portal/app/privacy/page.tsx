...
export const metadata: Metadata = {
  title: "Política de Privacidad · ClipHub",
};
...
export default function PrivacyPage() {
  return (
    <main>
      ...
      <p className="request-note">Última actualización: 7 de septiembre de 2026</p>
      ...
      <div className="card">
        ...
        <ul>
          <li>
            ...
            Discord recibimos tu nombre, tu dirección de correo, la URL de tu
            foto de perfil y el identificador que ese proveedor asigna a tu
            cuenta. No recibimos ni almacenamos tu contraseña.
          </li>
          <li>
          ...
          <li>
            <strong>El resultado.</strong> El vídeo generado a partir de tu
            demo.
          </li>
          <li>
      ...
      <div className="card">
        ...
        <p>
          ...
          propias peticiones y producir y entregarte el vídeo. No hay
      ...
      <div className="card">
        ...
        <p>
          La edición requiere el propio juego, así que tu demo se transfiere
          desde el servidor al ordenador personal del operador, en España, donde
          se graba y se monta el vídeo. La copia que hay en el servidor se
          borra en cuanto esa transferencia se completa: no mantenemos dos
          copias de tu demo.
        </p>
      </div>
      ...
      <div className="card">
        ...
        <ul>
          ...
          <li>
            <strong>El vídeo entregado:</strong> se borra automáticamente a los
            30 días de la entrega. Descárgalo antes de ese plazo.
          </li>
          <li>
            <strong>Tu cuenta y el historial de peticiones:</strong> se
            conservan mientras uses el servicio, hasta que pidas su supresión.
          </li>
        </ul>
      </div>
