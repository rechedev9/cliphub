...
func TestKeysUseStableJobLayout(t *testing.T) {
	...
	cases := map[string]string{
		...
		RecapPlanKey(id):         "jobs/11111111-1111-1111-1111-111111111111/recap-plan.json",
		FullDemoFaceitKey(id):    "jobs/11111111-1111-1111-1111-111111111111/full-demo-faceit.json",
		...
		ProgressKey(id):          "jobs/11111111-1111-1111-1111-111111111111/progress.json",
		AnticheatProgressKey(id): "jobs/11111111-1111-1111-1111-111111111111/anticheat-progress.json",
		TacticalProgressKey(id):  "jobs/11111111-1111-1111-1111-111111111111/tactical/progress.json",
		TacticalIndexKey(id):     "jobs/11111111-1111-1111-1111-111111111111/tactical/tactical.json",
		TacticalPositionsKey(id): "jobs/11111111-1111-1111-1111-111111111111/tactical/positions.zvpos",
		TacticalStatusKey(id):    "jobs/11111111-1111-1111-1111-111111111111/tactical/status.json",
	}
