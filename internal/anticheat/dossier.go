...
//
// It is deliberately not a submission client. FragForge never sends a report
...
func reportPolicy() ReportPolicy {
	return ReportPolicy{
		Summary: "FragForge prepara el expediente; la denuncia la presentas tú, una sola vez, desde tu propia cuenta.",
		Rules: []string{
		...
		Rejected: "FragForge no envía denuncias automáticamente ni genera denuncias múltiples contra una cuenta.",
	}
}
