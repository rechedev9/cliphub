...
// DeleteEditorAsset handles DELETE /api/editor/assets/{id}. A project whose
// timeline still references the asset fails its next render validation with a
// missing-asset error, which is the honest outcome of deleting media.
