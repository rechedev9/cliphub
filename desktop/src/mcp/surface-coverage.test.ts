...
const COVERAGE: readonly CoverageCase[] = [
  ...
  { input: JOB_INPUT, method: 'POST', operation: 'jobs.start_anticheat', route: '/api/jobs/{id}/anticheat' },
  { input: JOB_INPUT, method: 'GET', operation: 'jobs.anticheat', route: '/api/jobs/{id}/anticheat' },
  {
    input: { ...JOB_INPUT, steamid64: '76561198000000000' },
    method: 'GET',
    operation: 'jobs.anticheat_dossier',
    route: '/api/jobs/{id}/anticheat/dossier/{steamid}',
  },
  { input: JOB_INPUT, method: 'GET', operation: 'tactical.get_document', route: '/api/jobs/{id}/tactical' },
  { input: JOB_INPUT, method: 'POST', operation: 'tactical.start', route: '/api/jobs/{id}/tactical' },
  { input: JOB_INPUT, method: 'GET', operation: 'tactical.get_status', route: '/api/jobs/{id}/tactical/status' },
  { input: { ...JOB_INPUT, round: 1 }, method: 'GET', operation: 'tactical.get_round', route: '/api/jobs/{id}/tactical/rounds/{round}' },
  { input: JOB_INPUT, method: 'GET', operation: 'tactical.aggregate', route: '/api/jobs/{id}/tactical/aggregate' },
  { input: JOB_INPUT, method: 'GET', operation: 'tactical.get_positions_url', route: '/api/jobs/{id}/tactical/positions' },
  { input: { map: 'de_mirage' }, method: 'GET', operation: 'tactical.get_map_radar_url', route: '/api/maps/{map}/radar' },
  ...
  { input: STREAM_INPUT, method: 'POST', operation: 'streams.start_caption_candidates', route: '/api/stream-jobs/{id}/captions' },
  { input: STREAM_INPUT, method: 'GET', operation: 'streams.get_caption_candidates', route: '/api/stream-jobs/{id}/captions' },
  {
    input: {
      ...STREAM_INPUT,
      clips: [{ clip_id: 'clip-1', no_speech: true }],
      generation_id: '33333333-3333-4333-8333-333333333333',
    },
    method: 'POST',
    operation: 'streams.review_caption_candidates',
    route: '/api/stream-jobs/{id}/captions/review',
  },
  ...
  { input: STREAM_INPUT, method: 'POST', operation: 'streams.start_killfeed_analysis', route: '/api/stream-jobs/{id}/killfeed' },
  { input: STREAM_INPUT, method: 'GET', operation: 'streams.get_killfeed_analysis', route: '/api/stream-jobs/{id}/killfeed' },
  {
    input: { ...STREAM_INPUT, generation_id: '33333333-3333-4333-8333-333333333333' },
    method: 'POST',
    operation: 'streams.apply_killfeed_analysis',
    route: '/api/stream-jobs/{id}/killfeed/apply',
  },
