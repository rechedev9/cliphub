...
const DOWNLOAD_URL =
  "https://github.com/rechedev9/cliphub/releases/download/v5.3.1/ClipHub.Studio.Setup.5.3.1.exe";
const RELEASE_VERSION = "v5.3.1";
...
const FEATURES: {
  ...
  },
  {
    ...
    body: "HLAE drives CS2 locally and captures clean, high-fidelity POV footage instead of faking the moment.",
...
const REQUIREMENTS: { icon: LucideIcon; label: string; detail: string }[] = [
  ...
  { icon: Film, label: "Official HLAE 2.192.3", detail: "Bundled and installed automatically" },
