...
Usage:
  ...
  zv full-demo import --demo <match.dem> --steamid <SteamID64> [--dry-run] [--format text|json]
  zv full-demo asset --input <media> --provenance <provenance.json> [--dry-run] [--format text|json]
