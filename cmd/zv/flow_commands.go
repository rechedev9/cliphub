	...
	return []productionFlow{
		{
			...
			Phases: []flowPhase{
				...
				{ID: "full-demo-options", Goal: "inspect all explicit capture, audio, bumper and output choices", Command: "zv full-demo defaults --format json", When: "full-demo-pov-chill-v1", ReadOnly: true},
