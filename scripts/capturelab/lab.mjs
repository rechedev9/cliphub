...
async function mediaPhase(context) {
  const { evidenceDir, options, steps } = context;
  const editorial = await executeGoTests(context, 'full-demo-editorial-media', './internal/editor', 'TestFullDemoMasterDecodedAAC|TestFullDemoSponsorBumperAndAudioMediaCanary|TestFullDemoDecodedGameVoiceMix');
