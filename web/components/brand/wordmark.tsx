 ...
 * Its three parts stay tied to semantic brand tokens — including the vermilion
 * micro-accent — so it remains legible in high-contrast themes without shipping
 * a separate raster asset.
 */
export function BrandMark({ className }: { className?: string }) {
  return (
    <svg
      ...
      fill="none"
    >
      <path className="fill-fg-1" d="M8 8h46l-8 9H22v10h20l-8 9H22v16L8 62V8Z" />
