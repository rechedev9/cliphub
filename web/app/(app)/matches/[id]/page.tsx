...
/** Retired: the Short brief now lives under the partida in 01. */
export default async function RetiredMatchPage({
  params,
  searchParams,
}: {
  ...
  redirect(produceHref(id, PRODUCE_FORMAT.short, seriesId));
}
