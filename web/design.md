# FragForge Studio — design system v4
...
FragForge is a local-first replay workstation: a focused CS2 production tool, not a generic SaaS dashboard and not a decorative cyberpunk HUD.
